module ResponseCheckers
  ...
  def foodie_response_checker(response)
    expect(response).to be_a(Hash)
    expect(response).to have_key(:data)
    expect(response[:data]).to be_a(Hash)
    expect(response[:data]).to have_key(:id)
    ...
    expect(response[:data]).to have_key(:attributes)
    expect(response[:data][:attributes]).to be_a(Hash)
    expect(response[:data][:attributes]).to have_key(:end_location)
    expect(response[:data][:attributes][:end_location]).to be_a(String)
    ...
    expect(response[:data][:attributes][:restaurant]).to be_a(Hash)
    expect(response[:data][:attributes][:restaurant]).to have_key(:name)
    expect(response[:data][:attributes][:restaurant][:name]).to be_a(String)
    expect(response[:data][:attributes][:restaurant]).to have_key(:address)
    expect(response[:data][:attributes][:restaurant][:address]).to be_a(String)
  end
end
