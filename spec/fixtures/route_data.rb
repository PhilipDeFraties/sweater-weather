{:route=>
  {:hasTollRoad=>false,
   ...
   :sessionId=>"60072370-0387-6750-02b4-32a3-0a2b676abed1",
      ...
      :maneuvers=>
       [{:distance=>0.109,
        ...
        {:distance=>0.135,
         ...
         :signs=>[],
         :mapUrl=>
          "http://www.mapquestapi.com/staticmap/v5/map?key=x1D1mjuAyO5OsMC5Z9BZgKUwwGQyW71v&size=225,160&locations=39.73687744140625,-104.9848403930664|marker-2||39.73686981201172,-104.98737335205078|marker-3||&center=39.736873626708984,-104.9861068725586&defaultMarker=none&zoom=13&rand=3890331&session=60072370-0387-6750-02b4-32a3-0a2b676abed1",
         :transportMode=>"AUTO",
         :attributes=>0,
         :time=>22,
        ...
        {:distance=>2.485,
         ...
         :signs=>[],
         :mapUrl=>
          "http://www.mapquestapi.com/staticmap/v5/map?key=x1D1mjuAyO5OsMC5Z9BZgKUwwGQyW71v&size=225,160&locations=39.73686981201172,-104.98737335205078|marker-3||39.70085144042969,-104.98760986328125|marker-4||&center=39.7188606262207,-104.98749160766602&defaultMarker=none&zoom=8&rand=3890331&session=60072370-0387-6750-02b4-32a3-0a2b676abed1",
         :transportMode=>"AUTO",
         :attributes=>1024,
         :time=>360,
        ...
        {:distance=>0.014,
         ...
         :signs=>[],
         :mapUrl=>
          "http://www.mapquestapi.com/staticmap/v5/map?key=x1D1mjuAyO5OsMC5Z9BZgKUwwGQyW71v&size=225,160&locations=39.70085144042969,-104.98760986328125|marker-4||39.70073318481445,-104.98739624023438|marker-5||&center=39.70079231262207,-104.98750305175781&defaultMarker=none&zoom=15&rand=3890331&session=60072370-0387-6750-02b4-32a3-0a2b676abed1",
         :transportMode=>"AUTO",
         :attributes=>0,
         :time=>7,
